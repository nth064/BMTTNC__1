...
def rsa_sign_message():
    ...
    private_key, public_key = rsa_cipher.load_keys()  # Sửa lỗi thiếu dấu "="
...
def ecc_sign_message():
    try:
        ...
        private_key, _ = ecc_cipher.load_keys()  # Lấy khóa riêng tư
...
def ecc_verify_signature():
    ...
    try:
        ...
        public_key, _ = ecc_cipher.load_keys()  # Lấy khóa công khai
        signature = bytes.fromhex(signature_hex)
